...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/ca0f202a5b918306dc34956816fb4b0f9e557f5779a1017bb85da15c02c0ece9-Ecomm-Apple-Identifier-CSR-file-flow.png",
        "",
      ...
      "sizing": "100% ",
      "border": true,
      "caption": "Apple Pay integration with Clover Ecommerce API"
    }
  ]
}
[/block]
...
1. Log in to your <a href="https://developer.apple.com/account" target="_blank">Apple Developer account</a>.
...
3. Scroll down to **Apple Pay** > **API Integration**, and click the <span style="color: blue;">blue</span> link in the instructions to share your Apple Merchant ID identifier with Clover.

   [block:image]{"images":[{"image":["https://files.readme.io/33bd14bcf69abd4103da40c20e67efa5d31e1d28a95bffc6576882842cad6159-ApplePay-APIIntegration.png","","Clover Merchant Dashboard: Ecommerce Payments page > Apple Pay section > API Integration"],"align":"center","sizing":"100% ","border":true,"caption":"Clover Merchant Dashboard: Apple Pay API Integration domain verification link"}]}[/block]
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/4cd0ed1b89296bca0185e89c88b2fb1b039158d8078cf40dafd973e54c807579-2-ShareAppleMerchantID.png",
        "",
      ...
      "sizing": "60% ",
      "border": true,
      "caption": "Clover Merchant Dashboard: Share your Apple merchant information with Clover"
    }
  ]
}
[/block]
...
5. Click **OK**. The Manage Certificate Signing Requests pop-up appears.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/038c678d2a122457bbb59136d6e2918fff63ced076220ace5cd5531ad7e56a03-3-ApplePay-DownloadCert.png","","Clover Merchant Dashboard: Manage Certifcate Signing Request pop-up"],"align":"center","sizing":"60% ","border":true,"caption":"Clover Merchant Dashboard: Manage Certificate Signing Request pop-up"}]}[/block]
...
3. Scroll down to **Apple Pay** > **API Integration**. The Apple merchant ID identifier file you previously shared with Clover displays in the section.
   ...
   [block:image]{"images":[{"image":["https://files.readme.io/54af1a9ee1d7e5d9978ddb05d7103e74670f7191e2762d572f48a3c0a8144ad1-4-API-Integration-CSR-file.png","","Ecommerce Payments > API Integration section > Apple Pay merchant ID"],"align":"center","sizing":"90% ","border":true,"caption":"Clover Merchant Dashboard: Ecommerce Payments page > Apple Pay section > API Integration"}]}[/block]
...
- In the Identifier section, click the Apple merchant ID identifier. The Manage Certificate Signing pop-up appears.
  ...
  [block:image]{"images":[{"image":["https://files.readme.io/54cbbdc76f2a9e0260a028b71f39a05c1dfb936b6163c86e3c0f2c96888616c1-5-ApplePay-PaymentProcessing.png","","Manage Certificate Signing Requests pop-up"],"align":"center","sizing":"60% ","border":true,"caption":"Clover Merchant Dashboard: Manage Certificate Signing Requests pop-up"}]}[/block]
...
To use Apple Pay as part of your payment integration, you need to <a href= "https://developer.apple.com/documentation/passkit_apple_pay_and_wallet/apple_pay/payment_token_format_reference" target="_blank">pass information received from Apple Pay</a> in your payment token request. 

To start the integration with the Clover Ecommerce API, create a payment token for the Apple Pay digital wallet transaction. The server returns a `source` token that begins with `clv\_`. With a `source` token, you can create a charge, create and pay for orders, accept tips, and save customer cards for future transactions.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/070167b8f1a84dc9ba728a5a95edde6b5ac588a0e7c53277c67fa6687dba9be6-Ecomm-iframe-Apple-Verification.png",
        "",
      ...
      "sizing": "90% ",
      "border": true,
      "caption": "Apple Pay integration with Clover iframe"
    }
  ]
}
[/block]
...
- On the Developer Dashboard:
  ...
  3. In the **Hosted Iframe** option > **IFrame integration** section, click the <span style="color: blue;">blue</span> link in the instructions to enter information about the ecommerce website domain.

     [block:image]{"images":[{"image":["https://files.readme.io/3b9d636e12f4792f9bce396a9ba5e879d8994e11449a253a8ce556a5c9c69161-DevDashboard-iFrame-DomainVerificationLink.png","","Clover Developer Dashboard: Apple Pay iframe integration domain verification link"],"align":"center","sizing":"100% ","border":true,"caption":"Clover Developer Dashboard: Apple Pay iframe integration domain verification link"}]}[/block]
- On the Merchant Dashboard:

  1. Go to **Accounts & Setup** > **Ecommerce **> **Ecommerce Payments**. The Ecommerce Payments page appears.
  2. Scroll down to **Apple Pay** > **IFrame integration**, and click the <span style="color: blue;">blue</span> link in the instructions to enter information about the ecommerce website domain. 

     [block:image]{"images":[{"image":["https://files.readme.io/04b214a50c7eab34c289bb34e9f32455b3108bea2c8e705b806e7a9ff1da5d49-ApplePay-Iframe.png","","Clover Merchant Dashboard: Apple Pay iframe integration domain verification link"],"align":"center","sizing":"100% ","border":true,"caption":"Clover Merchant Dashboard: Apple Pay iframe integration domain verification link"}]}[/block]

When you click the <span style="color: blue;">blue</span> link either on the Developer Dashboard or the Merchant Dashboard, the Enable Apple Pay pop-up appears.
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://files.readme.io/94ce383bf89dedeb6a5ab95a64ebef2c80b0412895f12b93b451deaf44644844-EnableApplePay-VerificationFile.png",
        "",
      ...
      "sizing": "60% ",
      "border": true,
      "caption": "Clover Hosted iframe settings: Enable Apple Pay pop-up"
    }
  ]
}
[/block]
...
- Unsuccessful verification—An error message appears. In this case:
  - Make sure the verification file is in the correct location on your ecommerce website:`https://{domain}/.well-known/apple-developer-merchantid-domain-association.`
...
- <a href="https://developer.apple.com/apple-pay/Apple-Pay-Merchant-Integration-Guide.pdf" target="_blank">Apple Pay Merchant Integration Guide</a>
- [Create an Apple Pay wallet token](https://docs.clover.com/dev/docs/create-applepaywallet-token) tutorial
- [Create an Apple Pay token](https://docs.clover.com/dev/reference/create-apple-pay-token) endpoint
